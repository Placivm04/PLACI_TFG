...
Una vez que tenemos todos los modelos ganadores de todos los datasets, se han evaluado y obtenido las métricas mencionadas anteriormente (F1\_score, latencia, throughput, incremento RAM y CPU efectiva), además de matrices de confusión y curvas ROC de cada modelo.
