...
\section{Modelos Evaluados en Local}

Para terminar la comparativa entre los modelos es interesante ver el tiempo que tardarían en la fase de inferencia en un entorno más realista, es decir, cargar los modelos en nuestro propio ordenador (no usando un super servidor).
Hemos cargado los modelos ganadores entrenados en mi ordenador y hemos calculado el tiempo que tardaría en procesar todos los registros y hacer la predicción.

\subsection{Resultados UNSW-NB15}

\begin{table}[H]
\centering
\caption{Tiempo medio de inferencia y throughput aproximado en máquina local para UNSW-NB15}
\label{tab:inferencia_unsw}
\begin{tabular}{lrr}
\toprule
\textbf{Modelo} & \textbf{Tiempo medio (s)} & \textbf{Muestras/s aprox.} \\
\midrule
SVM      & 0.0155 & 16600905 \\
...
\begin{table}[H]
\centering
\caption{Tiempo medio de inferencia y throughput aproximado en máquina local para IoT-23}
...
\begin{table}[H] 
\centering
\caption{Tiempo medio de inferencia y throughput aproximado en máquina local para TON-IoT}
