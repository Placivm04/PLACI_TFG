...
determinantes para la viabilidad de la solución, relacionado con la tendencia \textit{Green AI}, que aboga por el desarrollo de modelos de inteligencia artificial más eficientes y sostenibles desde el punto de vista energético ~\cite{green_ai}.
...
Para la elaboración de este TFG, se ha seguido una metodología estructurada siguiendo un enfoque iterativo y experimental. Dada la naturaleza exploratoria del proyecto, se ha seguido una metodología mixta, combinando el modelo CRISP-DM con un enfoque experimental orientado al análisis de rendimiento.
...
\begin{itemize}
    ...
    \item Obtención y análisis de los \textit{datasets}, evaluando su viabilidad para el proyecto.
...
\begin{itemize}
    ...
    \item \textbf{Capítulo 4. Obtención y Análisis de Datos: } se detallan los \textit{datasets} elegidos con un análisis de ellos.
    ...
    \item \textbf{Apéndice A. Resultados completos de la optimización de hiperparámetros: } se presentan los resultados detallados de los experimentos realizados.
    \item \textbf{Apéndice B. Manual de instalación y uso: } se proporciona un manual detallado para la instalación y uso de las herramientas desarrolladas en este proyecto.
\end{itemize}