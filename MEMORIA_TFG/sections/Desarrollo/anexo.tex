\chapter*{Apéndice A. Resultados completos de la optimización de hiperparámetros}
\addcontentsline{toc}{chapter}{Apéndice A. Resultados completos de la optimización de hiperparámetros}
\label{anexo:optimizacion}

En este anexo se presenta el análisis detallado de los resultados obtenidos durante la fase de optimización de hiperparámetros para cada modelo y dataset.
