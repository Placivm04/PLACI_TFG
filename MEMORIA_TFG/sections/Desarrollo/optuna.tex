...
\midrule
\textbf{NumPy} & Operaciones numéricas, manejo de arrays y cálculo eficiente sobre matrices. \\
\textbf{Polars} & Procesamiento eficiente de datasets tabulares con gran volumen de registros. \\
\textbf{Pandas} & Manipulación de datos y creación de tablas sencillas de resultados. \\
\textbf{Psutil} & Monitorización de recursos del sistema y apoyo en la medición del rendimiento. \\
\textbf{Matplotlib} & Generación de gráficas y visualización de resultados experimentales. \\
\textbf{Seaborn} & Creación de visualizaciones estadísticas de forma más clara y legible. \\
\textbf{TensorFlow/Keras} & Implementación, entrenamiento y evaluación de modelos de deep learning. \\
\textbf{Scikit-learn} & Preprocesamiento, métricas de evaluación y entrenamiento de modelos clásicos. \\
\textbf{XGBoost} & Entrenamiento y evaluación del modelo basado en gradient boosting. \\
\textbf{LightGBM} & Entrenamiento eficiente de modelos de boosting sobre datos tabulares. \\
\textbf{CatBoost} & Entrenamiento de modelos de boosting con buen rendimiento en datos tabulares. \\
\textbf{Adversarial Robustness Toolbox} & Generación de ataques adversarios como FGSM y PGD. \\
\bottomrule
\end{tabular}%
}
\end{table}
...
% Optuna identifica un conjunto de soluciones que se encuentran en la \textbf{frontera de Pareto}, lo que significa que no hay otra solución que sea mejor en todas las métricas. Esto permite a los usuarios elegir entre diferentes compromisos según sus necesidades específicas, por lo que no presentamos una única solución.
